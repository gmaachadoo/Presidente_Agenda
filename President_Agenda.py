...
parser.add_argument("--start_date", type=str, required=True, help='Data no formato DD/MM/AAAA')
parser.add_argument("--end_date", type=str, required=True, help='Data no formato DD/MM/AAAA')
...
while current_date <= end_date:
    ...
    for commitment in commitments: # vou adicionar esse for dentro de um outro for que vai alterando até a data desejada
